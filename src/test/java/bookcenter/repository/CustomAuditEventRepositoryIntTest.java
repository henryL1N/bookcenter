...
import bookcenter.config.audit.AuditEventConverter;
import bookcenter.domain.PersistentAuditEvent;
...
import static bookcenter.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
