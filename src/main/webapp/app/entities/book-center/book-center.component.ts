...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/book-center'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    registerChangeInBookCenters() {
        this.eventSubscriber = this.eventManager.subscribe('bookCenterListModification', (response) => this.loadAll());
    }
